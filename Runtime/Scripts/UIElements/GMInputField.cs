...
namespace GentlyUI.UIElements {
	...
	public class GMInputField : GMSelectable, IPointerClickHandler,
		...
		bool IsParsingCharacter(char character) {
			// Check for specific parsing characters in addition to control characters
			return char.IsControl(character) || character == '\t' || character == '\v' || character == '\f' || character == '\b';
		}
		...
		public override void CreatePooledUICache() {
			...
			defaultCharacterLimit = characterLimit;
		}
		...
		public override void ResetPooledUI() {
			...
			SetCharacterLimit(defaultCharacterLimit);
