...
namespace GentlyUI {
	...
	public class GMSlicedFilledImage : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter {
...
#pragma warning restore 1692
		...
		private static List<GMSlicedFilledImage> m_TrackedTexturelessImages = new List<GMSlicedFilledImage>();
		...
		private static void RebuildImage(SpriteAtlas spriteAtlas) {
			for (int i = m_TrackedTexturelessImages.Count - 1; i >= 0; i--) {
				GMSlicedFilledImage image = m_TrackedTexturelessImages[i];
